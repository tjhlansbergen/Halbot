...
namespace Halbot.Code
{
    public class HalbotActivity : IComparable<HalbotActivity>
    {
        ...
        public int Week { get { return _weekOfYear(Date); } }
        public string Pace { get { return _paceForSpeed(Speed); } }
        ...
        private static string _paceForSpeed(double speed)
        {
            ...
            string seconds = Math.Round((60 * ((1 / (speed * 0.06)) - (Math.Floor(1 / (speed * 0.06)))))).ToString("00");
